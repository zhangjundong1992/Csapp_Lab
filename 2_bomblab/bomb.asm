...
0000000000400ee0 <phase_1>:
  ...
  400ee9:	e8 4a 04 00 00       	callq  401338 <strings_not_equal>   # 与内存0x401338处字符串比较
...
0000000000400efc <phase_2>:
  ...
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>    # 读取6个输入
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                  # 第一个输入为1
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax
  400f1a:	01 c0                	add    %eax,%eax                    # 每次循环eax值翻倍：1，2，4，8，16，32
  ...
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx               # 循环起始位置
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp              # 循环终止位置
...
0000000000400f43 <phase_3>:
  ...
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi           # 两个整数输入
  ...
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>    # 输入第一个参数须小于等于7（0~7）
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)       # 根据第一个输入值判断第二个输入值
